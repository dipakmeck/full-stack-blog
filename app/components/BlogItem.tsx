  ...
  return (
    <Card className="hover:border-slate-950 duration-500 flex flex-col w-[400px] h-[550px] mx-4 my-2 rounded-lg">
      ...
      <CardFooter className="w-full h-full p-3">
        <Link href={`/blogs/view/${props.id}`} className="ml-auto mt-auto border-[1px] p-3 rounded-lg hover:bg-violet-600 hover:text-violet-100 duration-500">View More</Link>
      </CardFooter>
    </Card>
  )
}
