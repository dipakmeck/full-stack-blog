    ...
    <section className="w-full h-full flex flex-col">
      <div className="mx-auto rounded-xl bg-slate-200 my-10 px-10 py-5">
        <div className="m-auto p-4 text-center">
          <span className="font-extrabold text-xl">Register To <Logo /> </span>
        </div>
        ...
        <label className="font-semibold text-2xl text-center text-slate-900" htmlFor="name">Name</label>
          ...
          <button onClick={handleSubmit(signUpWithCreds)} className="bg-violet-500 hover:bg-violet-600 text-white my-2 font-bold border-[1px] px-6 py-3 flex items-center justify-center gap-3 rounded-xl duration-300">Register{" "}<span><LogInIcon /></span></button>
